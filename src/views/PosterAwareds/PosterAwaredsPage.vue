...
<th scope='col'>updated</th>
												...
												<td>{{app.award_id}}</td><td>{{app.poster_id}}</td><td>{{app.created.split('T')[0]}}</td><td>{{app.updated.split('T')[0]}}</td>
													<td class="text-end">
														<button class="btn profile-edit-btn"
															@click="editPosterAwareds(app)" href="javascript: void(0);"
															role="button" data-bs-toggle="modal"
															data-bs-target="#edit-category"><i
																class="far fa-edit"></i></button>
														<a class="btn profile-edit-btn" href="javascript: void(0);" role="button"
															@click="deletePosterAwareds(app)"><i class="far fa-trash-alt"></i></a>
													</td>
												</tr>
											</table>
					...
					<div class="modal-body">
						<form @submit.prevent="addPosterAwareds()">
							<div class="mb-3">
								...
								<input required v-model="poster_awareds.award_id" dir="ltr" class="form-control" type="text">
								...
								<input required v-model="poster_awareds.poster_id" dir="ltr" class="form-control" type="text">
								<div class="invalid-feedback"> </div>

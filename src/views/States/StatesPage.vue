...
<th scope='col'>updated</th>
												...
												<td>{{app.country_id}}</td><td>{{app.name}}</td><td>{{app.created.split('T')[0]}}</td><td>{{app.updated.split('T')[0]}}</td>
													<td class="text-end">
														<button class="btn profile-edit-btn"
															@click="editStates(app)" href="javascript: void(0);"
															role="button" data-bs-toggle="modal"
															data-bs-target="#edit-category"><i
																class="far fa-edit"></i></button>
														<a class="btn profile-edit-btn" href="javascript: void(0);" role="button"
															@click="deleteStates(app)"><i class="far fa-trash-alt"></i></a>
													</td>
												</tr>
											</table>
					...
					<div class="modal-body">
						<form @submit.prevent="addStates()">
							<div class="mb-3">
								...
								<input required v-model="states.country_id" dir="ltr" class="form-control" type="text">
